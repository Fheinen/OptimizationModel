...
opt_prob.addVar('x1','c',lower=0.0005,upper=0.2995546,value=0.3)
opt_prob.addVar('x2','c',lower=0.0005,upper=0.2503117,value=0.3)
opt_prob.addVar('x3','c',lower=0.0005,upper=0.176632,value=0.3)
opt_prob.addVar('x4','c',lower=0.0005,upper=0.4342194,value=0.3)
opt_prob.addVar('x5','c',lower=0.0005,upper=0.3532385,value=0.3)
opt_prob.addVar('x6','c',lower=0.0005,upper=0.2421254,value=0.3)
opt_prob.addVar('x7','c',lower=0.0005,upper=0.2320532,value=0.3)
opt_prob.addVar('x8','c',lower=0.0005,upper=0.3413624,value=0.3)
opt_prob.addVar('x9','c',lower=0.0005,upper=0.2766059,value=0.3)
opt_prob.addVar('x10','c',lower=0.0005,upper=0.2257777,value=0.3)
