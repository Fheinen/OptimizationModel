...
def run_model(DesignVars):
    ...
    folder = 'E:/Users/fh/Documents/SubjectOptimisation/Fh/OptimizationStudies/OptimizationStudies'    
    ...
    macro = [['load "Optimization.main.any"',
        'classoperation Main.DesignVars.LocalStrengthFactorPlantarFlexors "Set Value" --value={:12f}'.format( DesignVars[0]),
        'classoperation Main.DesignVars.LocalStrengthFactorKneeExtensor "Set Value" --value={:12f}'.format( DesignVars[1]),
        'classoperation Main.DesignVars.LocalStrengthFactorKneeFlexor "Set Value" --value={:12f}'.format( DesignVars[2]),
        'classoperation Main.DesignVars.LocalStrengthFactorHipExtensor "Set Value" --value={:12f}'.format( DesignVars[3]),
        'classoperation Main.DesignVars.LocalStrengthFactorHipFlexor "Set Value" --value={:12f}'.format( DesignVars[4]),
